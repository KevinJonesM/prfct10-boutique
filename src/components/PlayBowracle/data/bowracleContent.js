...
export const DEMO_SECRET_BOW_CODES                             = [
  {
    ...
    house: "NOVA",
    secretHouse: "POISE",
    messageFamily: "SELF_TRUST",
    messageId: "POI-TRUST-01",
    bowCollection: "SECRET GARDEN · V1",
    bowName: "Stillwater Bloom",
...

  {
    code: "BWR-P3M82",
    house: "PRISM",
    secretHouse: "VELOCITY",
    messageFamily: "MOMENTUM",
    messageId: "VEL-MOMENTUM-06",
    bowCollection: "SECRET GARDEN · V1",
    bowName: "Dragonfly Rush",
...

  {
    ...
    house: "FLUX",
    secretHouse: "FLIGHT",
    messageFamily: "CONFIDENCE",
    messageId: "FLT-CONFIDENCE-16",
    bowCollection: "SECRET GARDEN · V1",
    bowName: "Moonwing",
  ...
  },
  {
    ...
    house: "VANTA",
    secretHouse: "POWER",
    messageFamily: "DISCIPLINE",
    messageId: "PWR-DISCIPLINE-12",
    bowCollection: "SECRET GARDEN · V1",
    bowName: "Firefly Gold",
    readingSeed: "power-pwr10",
    edition: "CORE-2026",
    status: "ACTIVE",
    bowConfig: {
      topColor: "#E6007E",
