...
export const colorMeanings = [
  ...
  ,{ id: "xmudPurple", nameEn: "XMUD Electric Purple", nameEs: "XMUD Morado eléctrico", value: "#7B2DFF", energyEn: "IMAGINATION", energyEs: "IMAGINACIÓN", descriptionEn: "Turn precision into a playful new possibility.", descriptionEs: "Convierte la precisión en una posibilidad nueva y juguetona." }
  ,{ id: "xmudSlime", nameEn: "XMUD Fluorescent Slime Green", nameEs: "XMUD Verde slime fluorescente", value: "#C8FF00", energyEn: "FLOW", energyEs: "FLUIDEZ", descriptionEn: "Stay adaptable through every transition.", descriptionEs: "Mantente adaptable en cada transición." }
  ,{ id: "xmudAqua", nameEn: "XMUD Slime Aqua", nameEs: "XMUD Aqua slime", value: "#35D6FF", energyEn: "MOVEMENT", energyEs: "MOVIMIENTO", descriptionEn: "Keep the sequence moving with bright intent.", descriptionEs: "Mantén la secuencia en movimiento con intención." }
  ,{ id: "xmudPink", nameEn: "XMUD Candy Pink", nameEs: "XMUD Rosa candy", value: "#FF4FC3", energyEn: "JOY", energyEs: "ALEGRÍA", descriptionEn: "Make the hard part feel a little more yours.", descriptionEs: "Haz que la parte difícil se sienta un poco más tuya." }
  ,{ id: "xmudOrange", nameEn: "XMUD Slime Orange", nameEs: "XMUD Naranja slime", value: "#FF6B35", energyEn: "ACTIVATION", energyEs: "ACTIVACIÓN", descriptionEn: "Switch on your first sharp, confident move.", descriptionEs: "Activa tu primer movimiento preciso y seguro." }
  ,{ id: "xmudLemon", nameEn: "XMUD Neon Lemon", nameEs: "XMUD Limón neón", value: "#F4FF32", energyEn: "SPARK", energyEs: "CHISPA", descriptionEn: "Bring a bright cue into the next count.", descriptionEs: "Lleva una señal brillante al siguiente tiempo." }
  ,{ id: "xmudGrape", nameEn: "XMUD Grape Purple", nameEs: "XMUD Uva morado", value: "#9B35FF", energyEn: "IMAGINATION", energyEs: "IMAGINACIÓN", descriptionEn: "See another route through the skill.", descriptionEs: "Imagina otra ruta dentro de la habilidad." }
  ,{ id: "xmudJelly", nameEn: "XMUD Jelly White", nameEs: "XMUD Blanco jelly", value: "#F5F4FF", energyEn: "CLARITY", energyEs: "CLARIDAD", descriptionEn: "Keep the signal clean and the next step clear.", descriptionEs: "Mantén la señal limpia y el siguiente paso claro." }
];
